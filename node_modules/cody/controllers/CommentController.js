...
CommentController.prototype.doList = function(param, finish) {
    ...
    self.query(self.sqlGetCommentByPage, param, function(err, res) {
        if (err) {
            ...
            console.log('idcomment: ' + self.context.comments[0].idcomment);
            console.log('comment: ' + self.context.comments[0].comment);
            console.log('page title: ' + self.context.page.title);
            console.log('page content: ' + self.context.page.content);
        }
